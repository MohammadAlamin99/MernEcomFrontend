...
export  async function AddWishListRequest(productID) {
   try {
       ...
       let result=await axios.post('https://e-commerse-project-xzpe.vercel.app/api/v1/CreateWishList/',reqBody, Headers);
...
export async function WishListRequest(){
    try {
        let result = await axios.get('https://e-commerse-project-xzpe.vercel.app/api/v1/WishList',Headers)
        let data = result.data;
        return data;
    } catch (e) {
...
export async function RemoveWishListRequest(productID){
    try {
        let reqBody = {"productID":productID} 
        let result = await axios.post('https://e-commerse-project-xzpe.vercel.app/api/v1/RemoveWishList',reqBody, Headers)
        let data = result.data;
        return data;
    } catch (e) {
...
export async function CartlistRequest(){
    try {
        let result = await axios.get('https://e-commerse-project-xzpe.vercel.app/api/v1/CartList',Headers);
        let data = result.data['data']
        return data;
    } catch (e) {
...
export async function RemoveCartlistRequest(productID){
    try {
        let reqbody = {"productID":productID}
        let result = await axios.post('https://e-commerse-project-xzpe.vercel.app/api/v1/RemoveCartList', Headers,reqbody);
        let data = result.data
        return data;
    } catch (e) {
...
export async function CreateCartlistRequest(reqbody){
    try {
        let result = await axios.post('https://e-commerse-project-xzpe.vercel.app/api/v1/CreateCartList',reqbody, Headers);
        let data = result.data
        return data;
    } catch (e) {
...
export async function InvoiceCreate(){
    try {
        let result = await axios.get('https://e-commerse-project-xzpe.vercel.app/api/v1/InvoiceCreate',Headers );
        let data = result.data
...
export  async function CreateProfileRequiest(
    ...
    try {
     let reqbody = {cus_name:cus_name,
                    ...
                    console.log(reqbody)
        let result = await axios.post('https://e-commerse-project-xzpe.vercel.app/api/v1/CreateProfile',reqbody,Headers);
